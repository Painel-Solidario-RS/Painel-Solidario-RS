...
const BasePage: React.FC<BasePageProps> = ({leftIcon=false, title, rightIcon=null, children}) => {
    return (
      <div className='base-page-container'>
        
        <div className="base-page-title-container">
          <div className='base-page-left-icon'>{leftIcon ? <BackArrowHeader/> : ''}</div>
          <div className='base-page-title'>{title}</div>
          <div className='base-page-right-icon'>{rightIcon ? rightIcon : null} </div>
        </div>
        <div className='base-page-children'>
          {children}
        </div>
      </div>
    );
